...
namespace MessagerieInterneAPI
{
    public class UtilisateurService
    {
        ...
        public async Task<UtilisateurModel> GetUtilisateurById(int idUtilisateur)
        {
        ...
        public List<UtilisateurModel> SearchUtilisateur(NpgsqlConnection liasonBase, string searchTerm, int idEspaceTravail)
        {
            ...
            string sql = @"SELECT 
                ...
                JOIN utilisateur_espace_travail uet ON uet.id_utilisateur = u.id_utilisateur
                WHERE uet.id_espace_travail = @idEspaceTravail
